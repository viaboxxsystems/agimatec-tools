...
public class SQLScriptParserTest extends TestCase {
  ...
  public void testParseLiteral3() throws Exception {
    String sql = "insert into jasper_report (jasper_report_id, name, description) values(1,'Automatenauslastung','Auslastung der Automaten');";
    parser.iterateSQL(visitor, sql);
    assertEquals("insert into jasper_report (jasper_report_id, name, description) values(1,'Automatenauslastung','Auslastung der Automaten')", visitor.getStatements().get(0));
  }
  ...
  public void testParseSingleLineComment() throws SQLException, IOException {
    String sql = "-- persistence 'ClientProfile'\n" + "CREATE TABLE ClientProfile("
        + "ObjectIdentifier char(17) NOT NULL ," + "  ObjectVersion integer NULL ," + "  ClientID char(17) NOT NULL ,"
